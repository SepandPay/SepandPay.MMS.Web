...
namespace MMSApp.Controllers
{
    public class AspNetRolesController : Controller
    {
        ...
        public AspNetRolesController(MMSPortalV3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AspNetRoles != null ? 
                          ...
                          Problem("Entity set 'MMSPortalV3Context.AspNetRoles'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,NormalizedName,ConcurrencyStamp")] AspNetRole aspNetRole)
        {
            if (id != aspNetRole.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'MMSPortalV3Context.AspNetRoles'  is null.");
            }
            var aspNetRole = await _context.AspNetRoles.FindAsync(id);
            if (aspNetRole != null)
            {
        ...
        private bool AspNetRoleExists(long id)
        {
