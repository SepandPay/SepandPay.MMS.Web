...
namespace MMSApp.Controllers
{
    public class AspNetUserLoginsController : Controller
    {
        ...
        public AspNetUserLoginsController(MMSPortalV3Context context)
        {
            _context = context;
        }
        ...
        {
            var mMSPortalV3Context = _context.AspNetUserLogins.Include(a => a.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'MMSPortalV3Context.AspNetUserLogins'  is null.");
            }
            var aspNetUserLogin = await _context.AspNetUserLogins.FindAsync(id);
            if (aspNetUserLogin != null)
            {
        ...
        {
          return (_context.AspNetUserLogins?.Any(e => e.LoginProvider == id)).GetValueOrDefault();
        }
    }
}
