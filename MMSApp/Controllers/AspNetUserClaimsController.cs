...
namespace MMSApp.Controllers
{
    public class AspNetUserClaimsController : Controller
    {
        ...
        public AspNetUserClaimsController(MMSPortalV3Context context)
        {
            _context = context;
        }
        ...
        {
            var mMSPortalV3Context = _context.AspNetUserClaims.Include(a => a.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MMSPortalV3Context.AspNetUserClaims'  is null.");
            }
            var aspNetUserClaim = await _context.AspNetUserClaims.FindAsync(id);
            if (aspNetUserClaim != null)
            {
