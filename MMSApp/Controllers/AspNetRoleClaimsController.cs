...
namespace MMSApp.Controllers
{
    public class AspNetRoleClaimsController : Controller
    {
        ...
        public AspNetRoleClaimsController(MMSPortalV3Context context)
        {
            _context = context;
        }
        ...
        {
            var mMSPortalV3Context = _context.AspNetRoleClaims.Include(a => a.Role);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MMSPortalV3Context.AspNetRoleClaims'  is null.");
            }
            var aspNetRoleClaim = await _context.AspNetRoleClaims.FindAsync(id);
            if (aspNetRoleClaim != null)
            {
